...
export const buttonVariants = cva(
  "relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-full border font-medium text-base outline-none transition-[box-shadow,transform,background-color,border-color] duration-(--duration-quick) ease-(--ease-smooth-out) before:pointer-events-none before:absolute before:inset-0 before:rounded-full motion-safe:not-disabled:hover:-translate-y-px motion-safe:not-disabled:active:translate-y-0 motion-safe:not-disabled:active:scale-(--scale-small) motion-safe:not-disabled:active:duration-(--duration-micro) motion-safe:not-disabled:data-pressed:scale-(--scale-small) pointer-coarse:after:absolute pointer-coarse:after:size-full pointer-coarse:after:min-h-11 pointer-coarse:after:min-w-11 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-64 data-loading:select-none data-loading:text-transparent sm:text-sm [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:-mx-0.5 [&_svg]:shrink-0",
  {
    defaultVariants: {
      size: "default",
      variant: "default",
